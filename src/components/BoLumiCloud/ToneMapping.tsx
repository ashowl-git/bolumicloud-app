...
export default function ToneMapping() {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-2xl font-normal text-gray-900 dark:text-slate-100 mb-4">톤 매핑 (pcond)</h2>
        ...
        <div className="border border-gray-200 dark:border-slate-700 p-6 space-y-4">
          {/* 파일 선택 */}
          <div>
            <label className="block text-sm text-gray-700 dark:text-slate-300 mb-2">파일 선택</label>
            <select
              value={selectedFile}
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-4 h-4"
              />
              <label htmlFor="human-sensitivity" className="text-sm text-gray-700 dark:text-slate-300">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-gray-700 dark:text-slate-300">출력 포맷:</span>
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4"
                />
                <span className="text-sm text-gray-700 dark:text-slate-300">PNG</span>
              </label>
              <label className="flex items-center gap-2">
                <input
                  type="radio"
                  ...
                  className="w-4 h-4"
                />
                <span className="text-sm text-gray-700 dark:text-slate-300">JPG</span>
              </label>
            </div>
          </div>
      ...
      {result && (
        <div className="border border-gray-200 dark:border-slate-700 p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-normal text-gray-900 dark:text-slate-100">Before / After</h3>
            <button
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {/* Before */}
            <div>
              <p className="text-xs text-gray-800 dark:text-slate-200 mb-2">Before (Original HDR)</p>
              <div className="border border-gray-200 dark:border-slate-700 p-4 bg-amber-50/50">
            ...
            {/* After */}
            <div>
              <p className="text-xs text-gray-800 dark:text-slate-200 mb-2">After (Tone Mapped)</p>
              <div className="border border-gray-200 dark:border-slate-700 relative min-h-[200px]">
                <Image
                  src={result}
                  alt="Tone mapped"
                  fill
      ...
      <div className="border border-gray-200 dark:border-slate-700 p-6 text-sm text-gray-800 dark:text-slate-200">
        <h4 className="font-medium text-gray-900 dark:text-slate-100 mb-2">pcond란?</h4>
