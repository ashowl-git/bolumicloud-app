    ...
    <div className="max-w-4xl mx-auto py-12">
      ...
      >
        ...
        <div className="border border-gray-200 dark:border-slate-700 p-6 mb-6">
          ...
          {/* 계산된 값 */}
          <div className="flex gap-6 text-sm text-gray-800 dark:text-slate-200 pt-4 border-t border-gray-200 dark:border-slate-700">
            <div>
              <span className="text-gray-900 dark:text-slate-100 font-medium">바닥 면적:</span> {floorArea} m²
            </div>
            <div>
              <span className="text-gray-900 dark:text-slate-100 font-medium">부피:</span> {volume} m³
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-200 dark:border-slate-700 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            {materials.map((mat) => (
              ...
              >
                <div
                  className="w-8 h-8 border border-gray-300 dark:border-slate-600"
                  style={{ backgroundColor: mat.color }}
                />
                <div className="text-sm text-gray-900 dark:text-slate-100">{mat.name}</div>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="mt-8 p-6 border border-gray-200 dark:border-slate-700">
          <h4 className="font-medium text-gray-900 dark:text-slate-100 mb-3">genbox 기능 설명</h4>

          <div className="space-y-3 text-sm text-gray-800 dark:text-slate-200">
            <p>
              <span className="font-medium text-gray-900 dark:text-slate-100">genbox:</span>
            ...
            <p>
              <span className="font-medium text-gray-900 dark:text-slate-100">재질:</span>
