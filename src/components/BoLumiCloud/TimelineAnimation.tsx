      ...
      >
        ...
        <div className="border border-gray-200 dark:border-slate-700 p-6 mb-6">
          ...
          <div className="flex justify-between items-center mb-2">
            <label className="text-sm text-gray-700 dark:text-slate-300">FPS (Frames per Second)</label>
            <span className="text-sm text-gray-800 dark:text-slate-200 font-medium">{fps} fps</span>
          </div>
        ...
        <div className="text-center">
          ...
          {generating && (
            <p className="text-sm text-gray-800 dark:text-slate-200 mt-4">
        ...
        <div className="mt-8 p-6 border border-gray-200 dark:border-slate-700">
          <h4 className="font-medium text-gray-900 dark:text-slate-100 mb-3">사용 예시</h4>
          <ul className="space-y-2 text-sm text-gray-800 dark:text-slate-200">
