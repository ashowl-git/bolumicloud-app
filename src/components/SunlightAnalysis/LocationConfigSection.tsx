              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (v >= -90 && v <= 90) onConfigChange({ latitude: v })
                  }}
                  disabled={disabled}
                  className={`w-full border px-2 py-1.5 text-xs tabular-nums
                ...
                />
                {(config.latitude < -90 || config.latitude > 90) && (
                  <p className="text-[10px] text-red-500 mt-0.5">-90 ~ 90 범위</p>
                )}
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const v = Number(e.target.value)
                    if (v >= -180 && v <= 180) onConfigChange({ longitude: v })
                  }}
                  disabled={disabled}
                  className={`w-full border px-2 py-1.5 text-xs tabular-nums
                    focus:outline-none disabled:opacity-50
                ...
                />
                {(config.longitude < -180 || config.longitude > 180) && (
                  <p className="text-[10px] text-red-500 mt-0.5">-180 ~ 180 범위</p>
                )}
              </div>
            </div>
          )}
