    ...
    >
      ...
      {pointCount > 0 && (
        <>
          ...
          <span className="text-xs text-gray-500 dark:text-slate-400 px-1">{pointCount}점</span>
          <button
            onClick={onClearAll}
            className="text-xs text-gray-400 dark:text-slate-500 hover:text-red-500 px-1"
          >
            초기화
          </button>
        </>
