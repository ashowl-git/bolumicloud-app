...
export default function OpticalPropertiesPanel({
  ...
  return (
    <div className="border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-3">
      ...
      {/* T/R/A Stacked bar */}
      <div className="flex h-7 w-full overflow-hidden border border-gray-200 dark:border-slate-700">
        <div
      ...
      <div className="flex gap-4 mt-1.5">
        ...
        {shgc !== undefined && (
          <span className="text-[10px] text-gray-500 dark:text-slate-400 ml-auto font-mono">
            SHGC {shgc.toFixed(2)}
          </span>
        )}
      </div>
